...
CREATE TABLE qa_filtr_weak (
    id INTEGER PRIMARY KEY,
    question TEXT NOT NULL,
    answer TEXT NOT NULL,
);
CREATE TABLE qa_filtr_weak_llmmodels (
    id INTEGER PRIMARY KEY,
    qa_filtr_weak_id INTEGER NOT NULL,
    llmmodels_id INTEGER NOT NULL,
    language TEXT NOT NULL,
    similarity REAL NOT NULL,
    answerLLM TEXT,
    FOREIGN KEY (qa_filtr_weak_id) REFERENCES qa_filtr_weak(id),
